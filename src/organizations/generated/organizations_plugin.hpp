/**
 * @file       organizations_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Organizations
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from organizations_openapi.json
 *
...
#ifndef ORGANIZATIONS_PLUGIN_HPP
#define ORGANIZATIONS_PLUGIN_HPP
...
///
/// Auto-generated plugin class for Organizations.
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/organizations", "/api/v1/organizations/{organizationId}"}))
...
///
/// CRUD handler for listOrganizations — list organizations entities
///
    virtual std::string listOrganizations(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("organizations", "organizations");
...
///
/// CRUD handler for createOrganization — create a new organizations entity
///
    virtual std::string createOrganization(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("organizations", "organizations", id);
...
///
/// CRUD handler for getOrganization — get a single organizations entity
///
...
///
/// CRUD handler for updateOrganization — update an existing organizations entity
///
    virtual std::string updateOrganization(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteOrganization — delete a organizations entity
///
    virtual std::string deleteOrganization(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/organizations", "listOrganizations",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listOrganizations(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/organizations", "createOrganization",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createOrganization(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/organizations/{organizationId}", "getOrganization",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getOrganization(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/organizations/{organizationId}", "updateOrganization",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateOrganization(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/organizations/{organizationId}", "deleteOrganization",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteOrganization(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~OrganizationsPlugin() override = default;

    std::string GetName() override { return "Organizations"; }
...
#endif // ORGANIZATIONS_PLUGIN_HPP
