/**
 * @file       analytics_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Analytics
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from analytics_openapi.json
 *
...
#ifndef ANALYTICS_PLUGIN_HPP
#define ANALYTICS_PLUGIN_HPP
...
///
/// Auto-generated plugin class for Analytics.
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/analytics/query"}))
...
///
/// CRUD handler for analyticsQuery — create a new query entity
///
    virtual std::string analyticsQuery(
        ...
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("analytics", "query", id);
    ...
    {
        pm->RegisterHandler("POST", "/api/v1/analytics/query", "analyticsQuery",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return analyticsQuery(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~AnalyticsPlugin() override = default;

    std::string GetName() override { return "Analytics"; }
