...
#ifndef MenuCategory_H_
#define MenuCategory_H_
...
public:
    ...
    bool operator==(const MenuCategory& rhs) const;
    bool operator!=(const MenuCategory& rhs) const;

    /////////////////////////////////////////////
    /// MenuCategory members
    ...
    friend  void to_json(nlohmann::json& j, const MenuCategory& o);
    friend  void from_json(const nlohmann::json& j, MenuCategory& o);
protected:
    std::string m_Id;
