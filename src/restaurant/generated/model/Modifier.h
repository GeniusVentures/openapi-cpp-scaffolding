...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::Money getPriceDelta() const;
    void setPriceDelta(org::openapitools::server::model::Money const& value);
    /// <summary>
    /// 
    /// </summary>
    ...
    friend  void to_json(nlohmann::json& j, const Modifier& o);
    friend  void from_json(const nlohmann::json& j, Modifier& o);
protected:
    std::string m_Id;
    ...
    org::openapitools::server::model::Money m_Price_delta;
