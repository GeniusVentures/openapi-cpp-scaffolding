/**
 * @file       inventory_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Inventory
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from inventory_openapi.json
 *
...
#ifndef INVENTORY_PLUGIN_HPP
#define INVENTORY_PLUGIN_HPP
...
///
/// Auto-generated plugin class for Inventory.
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/inventory/adjustments", "/api/v1/inventory/items", "/api/v1/inventory/items/{inventoryItemId}"}))
...
///
/// CRUD handler for adjustInventory — create a new adjustments entity
///
    virtual std::string adjustInventory(
        ...
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("inventory", "adjustments", id);
...
///
/// CRUD handler for listInventoryItems — list items entities
///
    virtual std::string listInventoryItems(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("inventory", "items");
...
///
/// CRUD handler for createInventoryItem — create a new items entity
///
    virtual std::string createInventoryItem(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("inventory", "items", id);
            if (!keyResult.has_value())
            {
                return R"({"error":{"code":"INVALID_KEY","message":"Failed to build storage key"}})";
            }
...
///
/// CRUD handler for getInventoryItem — get a single items entity
///
    virtual std::string getInventoryItem(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for updateInventoryItem — update an existing items entity
///
    virtual std::string updateInventoryItem(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteInventoryItem — delete a items entity
///
    virtual std::string deleteInventoryItem(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("POST", "/api/v1/inventory/adjustments", "adjustInventory",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return adjustInventory(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/inventory/items", "listInventoryItems",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listInventoryItems(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/inventory/items", "createInventoryItem",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createInventoryItem(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/inventory/items/{inventoryItemId}", "getInventoryItem",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getInventoryItem(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/inventory/items/{inventoryItemId}", "updateInventoryItem",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateInventoryItem(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/inventory/items/{inventoryItemId}", "deleteInventoryItem",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteInventoryItem(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }
