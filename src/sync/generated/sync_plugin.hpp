/**
 * @file       sync_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Sync
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from sync_openapi.json
 *
...
#ifndef SYNC_PLUGIN_HPP
#define SYNC_PLUGIN_HPP
...
///
/// Auto-generated plugin class for Sync.
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/sync/pull", "/api/v1/sync/push"}))
...
///
/// CRUD handler for syncPull — list pull entities
///
    virtual std::string syncPull(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("sync", "pull");
...
///
/// CRUD handler for syncPush — create a new push entity
///
    virtual std::string syncPush(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("sync", "push", id);
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/sync/pull", "syncPull",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return syncPull(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/sync/push", "syncPush",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return syncPush(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~SyncPlugin() override = default;
