/**
 * @file       integrations_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Integrations
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from integrations_openapi.json
 *
...
#ifndef INTEGRATIONS_PLUGIN_HPP
#define INTEGRATIONS_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/integrations", "/api/v1/integrations/{integrationId}"}))
...
///
/// CRUD handler for listIntegrations — list integrations entities
///
    virtual std::string listIntegrations(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("integrations", "integrations");
...
///
/// CRUD handler for createIntegration — create a new integrations entity
///
    virtual std::string createIntegration(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("integrations", "integrations", id);
...
///
/// CRUD handler for getIntegration — get a single integrations entity
///
    virtual std::string getIntegration(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for updateIntegration — update an existing integrations entity
///
    virtual std::string updateIntegration(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteIntegration — delete a integrations entity
///
    virtual std::string deleteIntegration(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/integrations", "listIntegrations",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listIntegrations(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/integrations", "createIntegration",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createIntegration(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/integrations/{integrationId}", "getIntegration",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getIntegration(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/integrations/{integrationId}", "updateIntegration",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateIntegration(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/integrations/{integrationId}", "deleteIntegration",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteIntegration(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~IntegrationsPlugin() override = default;

    std::string GetName() override { return "Integrations"; }
