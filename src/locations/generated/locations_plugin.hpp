/**
 * @file       locations_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Locations
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from locations_openapi.json
 *
...
#ifndef LOCATIONS_PLUGIN_HPP
#define LOCATIONS_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/locations", "/api/v1/locations/{locationId}"}))
...
///
/// CRUD handler for listLocations — list locations entities
///
    virtual std::string listLocations(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("locations", "locations");
...
///
/// CRUD handler for createLocation — create a new locations entity
///
    virtual std::string createLocation(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("locations", "locations", id);
...
///
/// CRUD handler for getLocation — get a single locations entity
///
...
///
/// CRUD handler for updateLocation — update an existing locations entity
///
    virtual std::string updateLocation(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteLocation — delete a locations entity
///
    virtual std::string deleteLocation(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/locations", "listLocations",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listLocations(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/locations", "createLocation",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createLocation(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/locations/{locationId}", "getLocation",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getLocation(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/locations/{locationId}", "updateLocation",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateLocation(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/locations/{locationId}", "deleteLocation",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteLocation(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~LocationsPlugin() override = default;

    std::string GetName() override { return "Locations"; }
