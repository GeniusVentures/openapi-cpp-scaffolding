...
public:
    ...
    /// 
    /// </summary>
    std::vector<org::openapitools::server::model::Location_hours_inner> getHours() const;
    void setHours(std::vector<org::openapitools::server::model::Location_hours_inner> const& value);
...
protected:
    ...
    std::vector<org::openapitools::server::model::Location_hours_inner> m_Hours;
    bool m_HoursIsSet;
