/**
 * @file       tenancy_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Tenancy
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from tenancy_openapi.json
 *
...
#ifndef TENANCY_PLUGIN_HPP
#define TENANCY_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/tenants", "/api/v1/tenants/{tenantId}"}))
...
///
/// CRUD handler for listTenants — list tenants entities
///
    virtual std::string listTenants(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("tenancy", "tenants");
...
///
/// CRUD handler for createTenant — create a new tenants entity
///
    virtual std::string createTenant(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("tenancy", "tenants", id);
...
///
/// CRUD handler for getTenant — get a single tenants entity
///
    virtual std::string getTenant(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for updateTenant — update an existing tenants entity
///
    virtual std::string updateTenant(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteTenant — delete a tenants entity
///
    virtual std::string deleteTenant(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/tenants", "listTenants",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listTenants(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/tenants", "createTenant",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createTenant(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/tenants/{tenantId}", "getTenant",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getTenant(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/tenants/{tenantId}", "updateTenant",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateTenant(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/tenants/{tenantId}", "deleteTenant",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteTenant(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~TenancyPlugin() override = default;

    std::string GetName() override { return "Tenancy"; }
