/**
 * @file       messaging_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Messaging
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from messaging_openapi.json
 *
...
#ifndef MESSAGING_PLUGIN_HPP
#define MESSAGING_PLUGIN_HPP
...
///
/// Auto-generated plugin class for Messaging.
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/messages", "/api/v1/messages/{messageId}"}))
...
///
/// CRUD handler for listMessages — list messages entities
///
    virtual std::string listMessages(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("messaging", "messages");
...
///
/// CRUD handler for createMessage — create a new messages entity
///
    virtual std::string createMessage(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("messaging", "messages", id);
...
///
/// CRUD handler for getMessage — get a single messages entity
///
...
///
/// CRUD handler for updateMessage — update an existing messages entity
///
    virtual std::string updateMessage(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteMessage — delete a messages entity
///
    virtual std::string deleteMessage(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/messages", "listMessages",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listMessages(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/messages", "createMessage",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createMessage(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/messages/{messageId}", "getMessage",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getMessage(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/messages/{messageId}", "updateMessage",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateMessage(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/messages/{messageId}", "deleteMessage",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteMessage(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~MessagingPlugin() override = default;

    std::string GetName() override { return "Messaging"; }
