/**
 * @file       edge_nodes_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Edge Nodes
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from edge_nodes_openapi.json
 *
...
#ifndef EDGE_NODES_PLUGIN_HPP
#define EDGE_NODES_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/local-nodes", "/api/v1/local-nodes/{localNodeId}", "/api/v1/local-nodes/{localNodeId}/heartbeat"}))
...
///
/// CRUD handler for listLocalNodes — list local-nodes entities
///
    virtual std::string listLocalNodes(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("edge_nodes", "local-nodes");
...
///
/// CRUD handler for createLocalNode — create a new local-nodes entity
///
    virtual std::string createLocalNode(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("edge_nodes", "local-nodes", id);
...
///
/// CRUD handler for getLocalNode — get a single local-nodes entity
///
    virtual std::string getLocalNode(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for updateLocalNode — update an existing local-nodes entity
///
    virtual std::string updateLocalNode(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteLocalNode — delete a local-nodes entity
///
    virtual std::string deleteLocalNode(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// Fallback handler for localNodeHeartbeat — operation type not recognized
///
    virtual std::string localNodeHeartbeat(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/local-nodes", "listLocalNodes",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listLocalNodes(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/local-nodes", "createLocalNode",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createLocalNode(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/local-nodes/{localNodeId}", "getLocalNode",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getLocalNode(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/local-nodes/{localNodeId}", "updateLocalNode",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateLocalNode(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/local-nodes/{localNodeId}", "deleteLocalNode",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteLocalNode(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/local-nodes/{localNodeId}/heartbeat", "localNodeHeartbeat",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return localNodeHeartbeat(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~Edge_NodesPlugin() override = default;

    std::string GetName() override { return "Edge_Nodes"; }
