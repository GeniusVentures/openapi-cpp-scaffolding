/**
 * @file       assets_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Assets
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from assets_openapi.json
 *
...
#ifndef ASSETS_PLUGIN_HPP
#define ASSETS_PLUGIN_HPP
...
///
/// Auto-generated plugin class for Assets.
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/assets", "/api/v1/assets/{assetId}"}))
...
///
/// CRUD handler for listAssets — list assets entities
///
    virtual std::string listAssets(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("assets", "assets");
...
///
/// CRUD handler for createAsset — create a new assets entity
///
    virtual std::string createAsset(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("assets", "assets", id);
...
///
/// CRUD handler for getAsset — get a single assets entity
///
...
///
/// CRUD handler for updateAsset — update an existing assets entity
///
    virtual std::string updateAsset(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteAsset — delete a assets entity
///
    virtual std::string deleteAsset(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/assets", "listAssets",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listAssets(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/assets", "createAsset",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createAsset(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/assets/{assetId}", "getAsset",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getAsset(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/assets/{assetId}", "updateAsset",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateAsset(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/assets/{assetId}", "deleteAsset",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteAsset(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }
...
public:
    ...
    std::string GetName() override { return "Assets"; }
