/**
 * @file       devices_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Devices
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from devices_openapi.json
 *
...
#ifndef DEVICES_PLUGIN_HPP
#define DEVICES_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/devices", "/api/v1/devices/{deviceId}", "/api/v1/devices/{deviceId}/commands"}))
...
///
/// CRUD handler for listDevices — list devices entities
///
    virtual std::string listDevices(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("devices", "devices");
...
///
/// CRUD handler for createDevice — create a new devices entity
///
    virtual std::string createDevice(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("devices", "devices", id);
...
///
/// CRUD handler for getDevice — get a single devices entity
///
...
///
/// CRUD handler for updateDevice — update an existing devices entity
///
    virtual std::string updateDevice(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteDevice — delete a devices entity
///
    virtual std::string deleteDevice(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// Fallback handler for sendDeviceCommand — operation type not recognized
///
    virtual std::string sendDeviceCommand(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/devices", "listDevices",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listDevices(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/devices", "createDevice",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createDevice(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/devices/{deviceId}", "getDevice",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getDevice(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/devices/{deviceId}", "updateDevice",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateDevice(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/devices/{deviceId}", "deleteDevice",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteDevice(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/devices/{deviceId}/commands", "sendDeviceCommand",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return sendDeviceCommand(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~DevicesPlugin() override = default;

    std::string GetName() override { return "Devices"; }
