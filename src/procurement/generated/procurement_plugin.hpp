/**
 * @file       procurement_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Procurement
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from procurement_openapi.json
 *
...
#ifndef PROCUREMENT_PLUGIN_HPP
#define PROCUREMENT_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/purchase-orders", "/api/v1/purchase-orders/{purchaseOrderId}"}))
...
///
/// CRUD handler for listPurchaseOrders — list purchase-orders entities
///
    virtual std::string listPurchaseOrders(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("procurement", "purchase-orders");
...
///
/// CRUD handler for createPurchaseOrder — create a new purchase-orders entity
///
    virtual std::string createPurchaseOrder(
        const RequestContext& ctx,
        const std::string& /*method*/,
        const std::string& /*urlPath*/,
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("procurement", "purchase-orders", id);
...
///
/// CRUD handler for getPurchaseOrder — get a single purchase-orders entity
///
    virtual std::string getPurchaseOrder(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for updatePurchaseOrder — update an existing purchase-orders entity
///
    virtual std::string updatePurchaseOrder(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deletePurchaseOrder — delete a purchase-orders entity
///
    virtual std::string deletePurchaseOrder(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/purchase-orders", "listPurchaseOrders",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listPurchaseOrders(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/purchase-orders", "createPurchaseOrder",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createPurchaseOrder(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/purchase-orders/{purchaseOrderId}", "getPurchaseOrder",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getPurchaseOrder(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/purchase-orders/{purchaseOrderId}", "updatePurchaseOrder",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updatePurchaseOrder(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/purchase-orders/{purchaseOrderId}", "deletePurchaseOrder",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deletePurchaseOrder(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~ProcurementPlugin() override = default;

    std::string GetName() override { return "Procurement"; }
