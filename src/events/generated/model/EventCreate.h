...
#ifndef EventCreate_H_
#define EventCreate_H_
...
public:
    ...
    bool operator==(const EventCreate& rhs) const;
    bool operator!=(const EventCreate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const EventCreate& o);
    friend  void from_json(const nlohmann::json& j, EventCreate& o);
protected:
    std::string m_Type;
