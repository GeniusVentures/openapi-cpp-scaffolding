...
const std::string EventsApi::base = "";

EventsApi::EventsApi(const std::shared_ptr<Pistache::Rest::Router>& rtr)
    : ApiBase(rtr)
{}
...
void EventsApi::setupRoutes() {
    ...
    router->addCustomHandler(Routes::bind(&EventsApi::events_api_default_handler, this));
}

void EventsApi::handleParsingException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleParsingException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> EventsApi::handleParsingException(const std::exception& ex) const noexcept {
    try {
        throw;
...
void EventsApi::handleOperationException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
...
void EventsApi::create_event_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(eventCreate);
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->create_event(bearerToken,eventCreate, idempotencyKey, xTenantId, xOrganizationId, xLocationId, response);
...
#define HTTP_BEARER_AUTH_DEFINED 0
#endif
#define REST_PATH "/api/v1/events" 
...
void EventsApi::delete_event_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {

        // Getting the path params
        auto eventId = request.param(":eventId").as<std::string>();
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->delete_event(bearerToken,eventId, idempotencyKey, xTenantId, xOrganizationId, xLocationId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->get_event(bearerToken,eventId, xTenantId, xOrganizationId, xLocationId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void EventsApi::list_events_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->list_events(bearerToken,xTenantId, xOrganizationId, xLocationId, limit, cursor, q, sort, locationId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void EventsApi::update_event_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        try {
            nlohmann::json::parse(request.body()).get_to(eventUpdate);
...
#define HTTP_BEARER_AUTH_DEFINED 1
            ...
            this->update_event(bearerToken,eventId, eventUpdate, idempotencyKey, xTenantId, xOrganizationId, xLocationId, response);
            } catch (Pistache::Http::HttpError &e) {
                response.send(static_cast<Pistache::Http::Code>(e.code()), e.what());
                return;
            } catch (std::exception &e) {
...
void EventsApi::events_api_default_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
