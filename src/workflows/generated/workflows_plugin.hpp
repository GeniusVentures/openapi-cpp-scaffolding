/**
 * @file       workflows_plugin.hpp
 * @brief      Auto-generated OOP plugin wrapper for AI-Native Business OS API - Workflows
 * @date       auto-generated
 *
 * DO NOT EDIT — regenerated from workflows_openapi.json
 *
...
#ifndef WORKFLOWS_PLUGIN_HPP
#define WORKFLOWS_PLUGIN_HPP
...
protected:
    ...
    REGISTER_PLUGIN(kDefaultPluginPriority, ({"/api/v1/workflows", "/api/v1/workflows/{workflowId}"}))
...
///
/// CRUD handler for listWorkflows — list workflows entities
///
    virtual std::string listWorkflows(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    {
        std::string prefix = KeyBuilder::MakePrefix("workflows", "workflows");
...
///
/// CRUD handler for createWorkflow — create a new workflows entity
///
        ...
        const std::string& body)
    {
        try
        {
            ...
            auto keyResult = KeyBuilder::Build("workflows", "workflows", id);
...
///
/// CRUD handler for getWorkflow — get a single workflows entity
///
    virtual std::string getWorkflow(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for updateWorkflow — update an existing workflows entity
///
    virtual std::string updateWorkflow(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
...
///
/// CRUD handler for deleteWorkflow — delete a workflows entity
///
    virtual std::string deleteWorkflow(
        const RequestContext& /*ctx*/,
        const std::string& /*method*/,
        const std::string& urlPath,
        const std::string& body)
    ...
    {
        pm->RegisterHandler("GET", "/api/v1/workflows", "listWorkflows",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return listWorkflows(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("POST", "/api/v1/workflows", "createWorkflow",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return createWorkflow(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("GET", "/api/v1/workflows/{workflowId}", "getWorkflow",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return getWorkflow(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("PATCH", "/api/v1/workflows/{workflowId}", "updateWorkflow",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return updateWorkflow(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
        pm->RegisterHandler("DELETE", "/api/v1/workflows/{workflowId}", "deleteWorkflow",
            [this](const RequestContext& ctx, const std::string& m, const std::string& p, const std::string& b) {
                return deleteWorkflow(ctx, m, p, b);
            }, GetName(), kStubHandlerPriority);
    }

public:
    ~WorkflowsPlugin() override = default;

    std::string GetName() override { return "Workflows"; }
