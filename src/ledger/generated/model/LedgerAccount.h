...
#ifndef LedgerAccount_H_
#define LedgerAccount_H_
...
public:
    ...
    bool operator==(const LedgerAccount& rhs) const;
    bool operator!=(const LedgerAccount& rhs) const;

    /////////////////////////////////////////////
    /// LedgerAccount members
    ...
    friend  void to_json(nlohmann::json& j, const LedgerAccount& o);
    friend  void from_json(const nlohmann::json& j, LedgerAccount& o);
protected:
    std::string m_Id;
