...
#ifndef PaymentCreate_H_
#define PaymentCreate_H_
...
public:
    ...
    bool operator==(const PaymentCreate& rhs) const;
    bool operator!=(const PaymentCreate& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const PaymentCreate& o);
    friend  void from_json(const nlohmann::json& j, PaymentCreate& o);
protected:
