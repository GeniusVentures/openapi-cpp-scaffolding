...
#ifndef LeaveRequest_H_
#define LeaveRequest_H_
...
public:
    ...
    bool operator==(const LeaveRequest& rhs) const;
    bool operator!=(const LeaveRequest& rhs) const;

    /////////////////////////////////////////////
    /// LeaveRequest members
    ...
    friend  void to_json(nlohmann::json& j, const LeaveRequest& o);
    friend  void from_json(const nlohmann::json& j, LeaveRequest& o);
protected:
    std::string m_Id;
